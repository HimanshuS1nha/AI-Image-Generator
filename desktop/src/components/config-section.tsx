...
const ConfigSection = ({
  ...
  return (
    <div className="flex flex-col gap-y-4 p-3 rounded-lg w-[25%] border-[0.5px] border-gray-500 bg-[#111311] h-fit">
      <p>Aspect Ratio</p>
      ...
      <div className="flex gap-2 items-center flex-wrap">
        {aspectRatios.map((ratio) => {
          return (
            ...
            >
              <p className="text-smbunx --bun shadcn@latest add textarea">
                {ratio.value}
              </p>
            </div>
          );
